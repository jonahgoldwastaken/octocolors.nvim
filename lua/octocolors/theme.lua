...
function M.setup(scheme)
	...
	theme.highlights = {
		...
		CmpItemAbbrDefault = { fg = c.fg.default },
		CmpItemAbbrMatchFuzzy = { link = "CmpItemAbbrMatch" },
		CmpItemMenuDefault = { link = "CmpItemAbbrDefault" },
		CmpItemKindColorDefault = { fg = light_dark(scale.blue[9], scale.blue[3]) },
		CmpItemKindPropertyDefault = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		CmpItemKindSnippetDefault = { fg = light_dark(scale.blue[7], scale.blue[4]) },
		CmpItemKindVariableDefault = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		CmpItemKindClassDefault = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		CmpItemKindEnumDefault = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		CmpItemKindInterfaceDefault = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		CmpItemKindTextDefault = { fg = light_dark(scale.blue[9], scale.blue[3]) },
		CmpItemKindKeywordDefault = { fg = light_dark(scale.red[7], scale.red[4]) },
		CmpItemKindFieldDefault = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		CmpItemKindUnitDefault = { fg = light_dark(scale.blue[7], scale.blue[4]) },
		CmpItemKindValueDefault = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		CmpItemKindFileDefault = { fg = light_dark(scale.yellow[7], scale.yellow[4]) },
		CmpItemKindFolderDefault = { fg = light_dark(scale.yellow[7], scale.yellow[4]) },
		CmpItemKindFunctionDefault = { fg = light_dark(scale.purple[7], scale.purple[4]) },
		CmpItemKindConstructorDefault = { fg = light_dark(scale.purple[9], scale.purple[3]) },
		CmpItemKindEventDefault = { fg = light_dark(scale.gray[6], scale.gray[4]) },
		CmpItemKindMethodDefault = { fg = light_dark(scale.purple[7], scale.purple[4]) },
		CmpItemKindOperatorDefault = { fg = light_dark(scale.blue[8], scale.blue[2]) },
		CmpItemKindEnumMemberDefault = { fg = light_dark(scale.blue[7], scale.blue[4]) },
		CmpItemKindReferenceDefault = { fg = light_dark(scale.blue[6], scale.blue[3]) },
		CmpItemKindTypeParameterDefault = { fg = light_dark(scale.blue[8], scale.blue[2]) },
		CmpItemKindConstantDefault = { fg = light_dark(scale.green[7], scale.green[4]) },
		CmpItemKindModuleDefault = { fg = light_dark(scale.red[7], scale.red[4]) },
		CmpItemKindStructDefault = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		...
		NoiceCompletionItemEnum = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		NoiceCompletionItemFile = { fg = light_dark(scale.yellow[7], scale.yellow[4]) },
		NoiceCompletionItemText = { fg = light_dark(scale.blue[9], scale.blue[3]) },
		NoiceCompletionItemUnit = { fg = light_dark(scale.blue[7], scale.blue[4]) },
		NoiceCompletionItemEvent = { fg = light_dark(scale.gray[6], scale.gray[4]) },
		NoiceCompletionItemValue = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		NoiceCompletionItemClass = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		NoiceCompletionItemColor = { fg = light_dark(scale.blue[9], scale.blue[3]) },
		NoiceCompletionItemField = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		NoiceCompletionItemFolder = { fg = light_dark(scale.yellow[7], scale.yellow[4]) },
		NoiceCompletionItemMethod = { fg = light_dark(scale.purple[7], scale.purple[4]) },
		NoiceCompletionItemModule = { fg = light_dark(scale.red[7], scale.red[4]) },
		NoiceCompletionItemStruct = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		NoiceCompletionItemDefault = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		NoiceCompletionItemKeyword = { fg = light_dark(scale.red[7], scale.red[4]) },
		NoiceCompletionItemSnippet = { fg = light_dark(scale.blue[7], scale.blue[4]) },
		NoiceCompletionItemConstant = { fg = light_dark(scale.green[7], scale.green[4]) },
		NoiceCompletionItemFunction = { fg = light_dark(scale.purple[7], scale.purple[4]) },
		NoiceCompletionItemProperty = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		NoiceCompletionItemVariable = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		NoiceCompletionItemReference = { fg = light_dark(scale.blue[6], scale.blue[3]) },
		NoiceCompletionItemInterface = { fg = light_dark(scale.orange[7], scale.orange[4]) },
		NoiceCompletionItemEnumMember = { fg = light_dark(scale.blue[7], scale.blue[4]) },
		NoiceCompletionItemConstructor = { fg = light_dark(scale.purple[9], scale.purple[3]) },
		NoiceCompletionItemTypeParameter = { fg = light_dark(scale.blue[8], scale.blue[2]) },
